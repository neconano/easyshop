...
class PromotionController extends BaseController {
	...
	public function get_home_seckill($shop_id="",$flag="") {
		/*get recent*/
		$list = $this->get_promotion('秒杀-index',$shop_id,$flag,'',1);
		return $list;
	}
	...
	public function setup_promotion_demo() {
		$this->change_shop(1);
		$data_arr['promotion'] = 12313;
		$data_arr['img'] = 12313;
		$data_arr['p_id'] = 1;
		$this->setup_promotion($data_arr,'秒杀');
		//$this->setup_promotion('444432','秒杀-index');
	}
	/*setup*/
	/*promotion must belong to an shop */
	public function setup_promotion($data_arr,$promotion_cat='主题',$id="",$delete=0) {
		if($delete == 1){
			$w['id'] = $id;
			$d['is_delete'] = 1;
		...
		D2("Promotion")->setup_promotion($data_arr,$promotion_cat,$id,$data_arr['p_id']);
		return true;
	}
